(()=>{
  ...
  const PROFILE_KEY='eperangkat.bahasa-inggris-tingkat-lanjut.fasef.v1.profile';
  ...
  function render(){
    const app=$('#app');
    if(!app)return;
    const p=profile(),grade=localStorage.getItem(GRADE_KEY)||'XI';
    ...
    app.innerHTML=`<div class="page-head"><div><span class="eyebrow">Kelas ${esc(grade)} · Fase F</span>
      ...
      <section class="card schedule-card">
        ...
        <div class="schedule-identity">
          ...
          <div><span>Mata Pelajaran</span><b>B. Inggris TL</b></div>
