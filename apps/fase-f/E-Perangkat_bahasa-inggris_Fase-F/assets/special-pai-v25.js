...
let p={};try{p=JSON.parse(localStorage.getItem('eperangkat.bahasa-inggris.fasef.v1.profile')||'{}')}catch(_){p={}}
apply(q.get('grade')||localStorage.getItem('eperangkat.bahasa-inggris.fasef.v1.grade')||'XI',p.rombel||'');
})();
