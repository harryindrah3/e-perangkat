(()=>{
  ...
  const grade=params.get('grade')||order.grade||'V';
  ...
  toc.innerHTML=`<div class="page-inner toc-inner">
    ...
    <div class="toc-meta">
      ...
      <div><span>Kelas / Fase</span><b>${esc(grade)} / C</b></div>
    ...
    <div class="page-foot"><span>Daftar Isi · E-Perangkat B. Indonesia Fase C</span><span>Kelas ${esc(grade)} · ${esc(profile.year||'')}</span></div>
  </div>`;
  pages[0].after(toc);
