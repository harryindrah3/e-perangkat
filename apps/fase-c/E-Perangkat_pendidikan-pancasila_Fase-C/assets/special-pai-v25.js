...
let p={};try{p=JSON.parse(localStorage.getItem('eperangkat.pendidikan-pancasila.fasec.v1.profile')||'{}')}catch(_){p={}}
apply(q.get('grade')||localStorage.getItem('eperangkat.pendidikan-pancasila.fasec.v1.grade')||'V',p.rombel||'');
})();
