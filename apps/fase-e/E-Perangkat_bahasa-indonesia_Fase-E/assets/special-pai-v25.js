...
let p={};try{p=JSON.parse(localStorage.getItem('eperangkat.bahasa-indonesia.fasee.v1.profile')||'{}')}catch(_){p={}}
apply(q.get('grade')||localStorage.getItem('eperangkat.bahasa-indonesia.fasee.v1.grade')||'X',p.rombel||'');
})();
