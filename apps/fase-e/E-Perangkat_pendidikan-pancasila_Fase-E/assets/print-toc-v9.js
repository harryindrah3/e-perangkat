(()=>{
  ...
  const grade=params.get('grade')||order.grade||'X';
  ...
  toc.innerHTML=`<div class="page-inner toc-inner">
    ...
    <div class="page-foot"><span>Daftar Isi · E-Perangkat Pancasila Fase E</span><span>Kelas ${esc(grade)} · ${esc(profile.year||'')}</span></div>
  </div>`;
  pages[0].after(toc);
