(()=>{
  ...
  const PROFILE_KEY='eperangkat.pendidikan-agama-islam.fasea.v1.profile';
  ...
  function render(){
    ...
    $('#resetScheduleExample').onclick=()=>{
      ...
      rows.push(
        {semester:'1',className:'I',day:'SENIN',time:'08.00 – 10.15',hours:3},
        {semester:'2',className:'I',day:'SENIN',time:'08.00 – 10.15',hours:3}
      );
