(()=>{
  ...
  const grade=params.get('grade')||order.grade||'I';
  ...
  toc.innerHTML=`<div class="page-inner toc-inner">
    ...
    <div class="toc-meta">
      ...
      <div><span>Kelas / Fase</span><b>${esc(grade)} / A</b></div>
    ...
    <div class="page-foot"><span>Daftar Isi · E-Perangkat B. Indonesia Fase A</span><span>Kelas ${esc(grade)} · ${esc(profile.year||'')}</span></div>
  </div>`;
  pages[0].after(toc);
