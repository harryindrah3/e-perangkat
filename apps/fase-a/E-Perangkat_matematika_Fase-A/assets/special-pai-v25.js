...
let p={};try{p=JSON.parse(localStorage.getItem('eperangkat.matematika.fasea.v1.profile')||'{}')}catch(_){p={}}
apply(q.get('grade')||localStorage.getItem('eperangkat.matematika.fasea.v1.grade')||'I',p.rombel||'');
})();
