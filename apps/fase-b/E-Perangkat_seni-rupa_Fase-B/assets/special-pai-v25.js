...
let p={};try{p=JSON.parse(localStorage.getItem('eperangkat.seni-rupa.faseb.v1.profile')||'{}')}catch(_){p={}}
apply(q.get('grade')||localStorage.getItem('eperangkat.seni-rupa.faseb.v1.grade')||'III',p.rombel||'');
})();
