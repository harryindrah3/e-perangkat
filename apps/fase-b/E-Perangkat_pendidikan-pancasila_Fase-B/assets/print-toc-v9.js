(()=>{
  ...
  const grade=params.get('grade')||order.grade||'III';
  ...
  toc.innerHTML=`<div class="page-inner toc-inner">
    ...
    <div class="toc-meta">
      ...
      <div><span>Kelas / Fase</span><b>${esc(grade)} / B</b></div>
    ...
    <div class="page-foot"><span>Daftar Isi · E-Perangkat Pancasila Fase B</span><span>Kelas ${esc(grade)} · ${esc(profile.year||'')}</span></div>
  </div>`;
  pages[0].after(toc);
