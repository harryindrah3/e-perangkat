...
let p={};try{p=JSON.parse(localStorage.getItem('eperangkat.pendidikan-pancasila.faseb.v1.profile')||'{}')}catch(_){p={}}
apply(q.get('grade')||localStorage.getItem('eperangkat.pendidikan-pancasila.faseb.v1.grade')||'III',p.rombel||'');
})();
