(()=>{
  ...
  const PROFILE_KEY='eperangkat.pendidikan-agama-islam.faseb.v1.profile';
  ...
  function rowHtml(row,index){
    return `<tr data-schedule-index="${index}">
      ...
      <td><input data-field="className" value="${esc(row.className)}" placeholder="III"></td>
  ...
  function render(){
    const app=$('#app');
    if(!app)return;
    const p=profile(),grade=localStorage.getItem(GRADE_KEY)||'III';
    ...
    app.innerHTML=`<div class="page-head"><div><span class="eyebrow">Kelas ${esc(grade)} · Fase B</span>
      ...
      <section class="card schedule-card">
        ...
        <div class="schedule-identity">
          ...
          <div><span>Mata Pelajaran</span><b>PAIBP</b></div>
    ...
    $('#resetScheduleExample').onclick=()=>{
      ...
      rows.push(
        {semester:'1',className:'III',day:'SENIN',time:'08.00 – 10.15',hours:3},
        {semester:'2',className:'III',day:'SENIN',time:'08.00 – 10.15',hours:3}
      );
