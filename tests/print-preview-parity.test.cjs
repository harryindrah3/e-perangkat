...
const document={readyState:'loading',documentElement:{},getElementById:()=>({dataset:{}}),addEventListener:(type,fn)=>{docEvents[type]=fn;},querySelector:()=>{reads++;return null;},querySelectorAll:()=>{reads++;return [];}};
